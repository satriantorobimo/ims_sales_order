...
class ApplicationForm1ResumeMobileScreen extends StatefulWidget {
  const ApplicationForm1ResumeMobileScreen(
      {super.key, required this.applicationNo});
  final String applicationNo;

  @override
  State<ApplicationForm1ResumeMobileScreen> createState() =>
      _ApplicationForm1ResumeMobileScreenState();
}

class _ApplicationForm1ResumeMobileScreenState
    extends State<ApplicationForm1ResumeMobileScreen> {
  bool isLoading = true;
  String gender = 'MALE';
