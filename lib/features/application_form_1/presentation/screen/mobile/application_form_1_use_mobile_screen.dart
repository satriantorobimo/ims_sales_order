...
class ApplicationForm1UseMobileScreen extends StatefulWidget {
  const ApplicationForm1UseMobileScreen(
      {super.key, required this.addClientRequestModel});
  final AddClientRequestModel addClientRequestModel;

  @override
  State<ApplicationForm1UseMobileScreen> createState() =>
      _ApplicationForm1UseMobileScreenState();
}

class _ApplicationForm1UseMobileScreenState
    extends State<ApplicationForm1UseMobileScreen> {
  bool isLoading = true;
  String gender = 'MALE';
              ...
              BlocListener(
                ...
                listener: (_, ClientState state) {
                  ...
                  if (state is ClientUseLoaded) {
                    applicationNo = state.addClientResponseModel.code!;
                    getClientBloc.add(
                        GetClientAttempt(state.addClientResponseModel.code!));
                  }
                ...
                listener: (_, GetClientState state) {
                  ...
                  if (state is GetClientLoaded) {
                    setState(() {
                      ...
                      clientDetailResponseModel.applicationNo = applicationNo;
                                              ...
                                              if (selectMaritalStatus ==
                                                ...
                                                if (ctrlDate.text.isEmpty ||
                                                  ...
                                                  clientDetailResponseModel
                                                      ...
                                                      ctrlAddress.text;
                                                  clientDetailResponseModel
                                                      .addressRt = ctrlRt.text;
                                                  clientDetailResponseModel
                                                      .addressRw = ctrlRw.text;

                                                  Navigator.pushNamed(
                                                      context,
                                                      StringRouterUtil
                                                          .applicationForm2UseScreenMobileRoute,
                                                      arguments:
                                                          clientDetailResponseModel);
                                                }
                                              } else {
