...
class ApplicationForm2UseMobileScreen extends StatefulWidget {
  const ApplicationForm2UseMobileScreen({super.key, required this.data});
  final cd.Data data;

  @override
  State<ApplicationForm2UseMobileScreen> createState() =>
      _ApplicationForm2UseMobileScreenState();
}

class _ApplicationForm2UseMobileScreenState
    extends State<ApplicationForm2UseMobileScreen> {
  String gender = 'MALE';
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          if (ctrlBankNo.text.isEmpty ||
                                            ...
                                            clientBloc.add(ClientUpdateAttempt(
                                              ...
                                              pClientIdNo:
                                                  widget.data.clientIdNo,
                                              pClientFullName:
                                                  widget.data.clientFullName,
                                              pClientAreaMobileNo: widget
                                                  .data.clientAreaMobileNo,
                                              pClientMobileNo:
                                                  widget.data.clientMobileNo,
                                              pClientEmail:
                                                  widget.data.clientEmail,
                                              pClientPlaceOfBirth: widget
                                                  .data.clientPlaceOfBirth,
                                              pClientDateOfBirth:
                                              ...
                                              pAddressProvinceCode: widget
                                                  .data.addressProvinceCode,
                                              pAddressProvinceName: widget
                                                  .data.addressProvinceName,
                                              pAddressCityCode:
                                              ...
                                              pAddressZipCode: widget
                                                  .data.addressZipCodeCode,
                                              pAddressZipName:
                                                  widget.data.addressZipName,
                                              pAddressSubDistrict: widget
