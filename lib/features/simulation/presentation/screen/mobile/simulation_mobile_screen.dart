...
class SimulationMobileScreen extends StatefulWidget {
  const SimulationMobileScreen({super.key});

  @override
  State<SimulationMobileScreen> createState() => _SimulationMobileScreenState();
}
                          ...
                          builder: (_, SimulationState state) {
                            ...
                            if (state is SimulationLoaded) {
                              return ListView.separated(
                                  ...
                                  itemCount: state
                                      .simulationResponseModel.data!.length,
                                  separatorBuilder:
                                  ...
                                  itemBuilder:
                                    ...
                                    return Theme(
                                        ...
                                        child: ExpansionTile(
                                            ...
                                            title: Text(
                                              'Tenor ${state.simulationResponseModel.data![index].tenor}',
                                              style: const TextStyle(
                                                  color: Color(0xFF222222),
                                                  fontSize: 14,
